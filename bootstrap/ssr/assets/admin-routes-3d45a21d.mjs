...
const IconList = React.lazy(() => import("./icon-list-270408bc.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-64e3383f.mjs"));
...
//# sourceMappingURL=admin-routes-3d45a21d.mjs.map
