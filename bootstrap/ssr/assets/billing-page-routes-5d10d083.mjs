...
import { aL as useAuth, an as useUser, r as StaticPageTitle, T as Trans, aM as Navbar, a7 as ProgressCircle, bg as Footer, a8 as useNavigate, u as useSettings, B as Button, t as queryClient, m as message, a as apiClient, au as useProducts, p as opacityAnimation, L as CheckIcon, q as Skeleton, l as useTrans, v as toast, w as showHttpErrorToast, O as FormattedDate, N as Chip } from "../server-entry.mjs";
import { Fragment, useState, useRef, useEffect, memo, createElement } from "react";
import { B as Breadcrumb, a as BreadcrumbItem, S as SectionHelper, E as EditIcon } from "./Edit-48c44acf.mjs";
import { S as StripeElementsForm, B as BillingRedirectMessage } from "./billing-redirect-message-aad61e34.mjs";
import { loadStripe } from "@stripe/stripe-js";
import { F as FormattedPrice, a as FormattedCurrency } from "./formatted-price-ba2c819c.mjs";
import { AnimatePresence, m } from "framer-motion";
import { R as RadioGroup, c as Radio, u as useCancelSubscription, b as useResumeSubscription } from "./use-resume-subscription-38083e86.mjs";
...
function CardPaymentMethod({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: methodClassName, children: [
      /* @__PURE__ */ jsx("span", { className: "capitalize", children: user == null ? void 0 : user.card_brand }),
      " ••••",
      user == null ? void 0 : user.card_last_four,
      (user == null ? void 0 : user.card_expires) && /* @__PURE__ */ jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsx(Trans, { message: "Expires :date", values: { date: user == null ? void 0 : user.card_expires } }) })
    ] }),
...
//# sourceMappingURL=billing-page-routes-5d10d083.mjs.map
