...
const IconList = React.lazy(() => import("./icon-list-b2eda49b.mjs"));
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-289e5778.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-24fc9300.mjs"));
...
//# sourceMappingURL=admin-routes-8a045b1c.mjs.map
