...
const IconList = React.lazy(() => import("./icon-list-afe6e4b0.mjs"));
...
const AceEditor = React.lazy(() => import("./ace-editor-b42cebec.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-1f519799.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-54567ffd.mjs"));
...
//# sourceMappingURL=admin-routes-81cadf2d.mjs.map
